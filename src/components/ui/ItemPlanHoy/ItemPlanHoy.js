...
const ItemPlanHoy = ({ colorSquare, calls, msgs, title }) => {
    ...
    // Validaciones
    if (colorSquare == null) colorSquare = '-webkit-linear-gradient(left, rgba(147, 195, 240, 1) 0%, rgba(9, 79, 153, 1) 100%)';
    ...
    const styleNumber = { background: colorSquare, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' };
    ...
    return (
        <div className='inline-top-div card-page container-item-plan-hoy'>
            <div ref={refSquare} className='sqare-number' >
                <div className='circle-sqare-number'>
                </div>
                <p style={styleNumber} className='number-square-number' >{calls + msgs}</p>
            </div>
            <div className='text-item-plan-hoy'>
                ...
                <table>
                    <tbody>
                        <tr>
                            <td><PhoneIcon fontSize='small' /></td>
                            <td>{calls}</td>
                        </tr>
                        <tr>
                            <td><MsgIcon fontSize='small' /></td>
                            <td>{msgs}</td>
                        </tr>
                    </tbody>
                </table>
